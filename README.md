...
<p align="center">
  <img src="assets/paper-preview.png" alt="Presto-SCA-Unofficial paper or project page preview" width="900">
</p>
...
| Item | Details |
|---|---|
| Paper | Long Video Diffusion Generation with Segmented Cross-Attention and Content-Rich Video Data Curation |
| Venue / Source | CVPR 2025 |
| Focus | This repository organizes a PyTorch implementation for Long Video Diffusion Generation with Segmented Cross-Attention and Content-Rich Video Data Curation, focusing on long vide... |
...
This repository organizes a PyTorch implementation for **Long Video Diffusion Generation with Segmented Cross-Attention and Content-Rich Video Data Curation**, focusing on long video diffusion with segmented cross-attention. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```python
import torch
from presto_sca_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables, pp. 3184-3194 | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Yan_Long_Video_Diffusion_Generation_with_Segmented_Cross-Attention_and_Content-Rich_Video_CVPR_2025_paper.html) |
| Ablation study | Ablation / experiment section | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Yan_Long_Video_Diffusion_Generation_with_Segmented_Cross-Attention_and_Content-Rich_Video_CVPR_2025_paper.html) |
| Qualitative examples | Main paper figures and supplemental material | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Yan_Long_Video_Diffusion_Generation_with_Segmented_Cross-Attention_and_Content-Rich_Video_CVPR_2025_paper.html) |
...
- Thanks to the authors of **Long Video Diffusion Generation with Segmented Cross-Attention and Content-Rich Video Data Curation** for the original research.
...
cvpr-2025, pytorch, unofficial-implementation, long-video-generation, cross-attention, diffusion-model
